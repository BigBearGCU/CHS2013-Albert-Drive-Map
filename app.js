...
function CreateKMLMapOverlay(googleMap)
{
    ...
    myParser.parse(["resources/AlbertRoadStatic2.kml","resources/AlbertDriveMediaStatic.kml",
        "resources/AlbertDriveMedia.kml","resources/AlbertDrivePublicSpaces.kml",
